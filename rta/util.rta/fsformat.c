...
#define	GRANULES	BANKS_IN_DEVICE * (262144/GRANULE)
...
static int interpret(tree *actual, unsigned *displacement, long long dstart_granule, forward *up1)
{
   ...
   else if (strcmp(command, "tree")   == 0)
   {
      ...
      *displacement = slab + new->ex.rfw.t3 + 1;
      ...
      slot = 262144/GRANULE - (gpointer & (262144/GRANULE-1));
      slot *= GRANULE;
            ...
            else
            {
               ...
               else
               {
                  ...
                  *displacement += new->ex.rfw.t3 + 1;
                  ...
                  while (p32--)
                  {
                     printf("%s extent %d granules\n", argument, 262144/GRANULE);
                     extra->rfw = extrahead;
                 
                     extra->granules.t1 = (262144/GRANULE) >> 16;
                     extra->granules.t2 = (262144/GRANULE) >>  8;
                     extra->granules.t3 =  262144/GRANULE;
