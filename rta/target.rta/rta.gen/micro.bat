...
rem rem #	%1 is for the absolute listing option -d 
rem rem #	which is also the .txo absolute summary option
rem rem #	passed forward in links
...
rem rem #	cd ..\async
rem rem #	masmx async2 async2 -lnxkzyd >list.txt
rem rem #	.\make
popd
